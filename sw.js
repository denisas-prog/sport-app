...
const CACHE_NAME = 'sale-v3.4'; // keisti kartu su versija index.html "Apie" skiltyje
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('fetch', (event) => {
  ...
  if (isHTML) {
    event.respondWith(
      // v3.4: cache:'no-cache' — apeinam naršyklės HTTP cache (GitHub Pages max-age=600),
      // kitaip „network-first" iki 10 min. atiduodavo seną index.html ir baneris nepasirodydavo
